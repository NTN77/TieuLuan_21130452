...
public class SecurityConfig {
    ...
    ENDPOINTS_GET_ADMIN = {"/user/allUser","/admin/dashboard/dataDashBoard","/admin/findByUser/{id}","/admin/allEvent","/admin/eventDetail","/admin/orderManagerEvent","/admin/allCustomerOfEvent","/admin/exportCustomers","/admin/Log"}, // endpoint dành riêng cho admin
    ENDPOINTS_POST_ADMIN = { "/event/createEvent","/event/addBTC","/admin/updateStatus","/admin/updateInformation","/admin/updateStatusEvent","/admin/editEvent","/admin/updateBibAndSendMail","/admin/editInformationSignIn","/admin/updateStatusBTC"}; // endpoint dành riêng cho admin
